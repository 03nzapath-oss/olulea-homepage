    ...
    <div className="w-full">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full bg-secondary flex items-center justify-center overflow-hidden">
        <Image
          ...
          alt="Salon Interior"
          className="absolute inset-0 w-full h-full object-cover blur-[2.5px] scale-105 saturate-[1.1] contrast-[1.1] brightness-[1.05]"
        />
        {/* 極薄い白いオーバーレイ */}
        <div className="absolute inset-0 bg-white/[0.3]"></div>
        <div
